        ...
        <div>
            ...
            <ul id="wd-modules">
                <li className="wd-module">
                    <span className="wd-title">Week 1, Lecture 1 - Course Introduction, Syllabus, Agenda</span>
                    <ul className="wd-lessons">
                        ...
                        <li className="wd-lesson">
                            ...
                            <ul className="wd-content">
                                ...
                                <li className="wd-content-item">Creating an HTTP server with
                                    Node.js
                                </li>
                ...
                <li className="wd-module">
                    <span className="wd-title">Week 1, Lecture 2 - Formatting User Interfaces with HTML</span>
                    <ul className="wd-lessons">
                        <li className="wd-lesson">
                            <span className="wd-title">LEARNING OBJECTIVES</span>
                            <ul className="wd-content">
                                <li className="wd-content-item">Learn how to create user interfaces
                                    with HTML
                                </li>
                        ...
                        <li className="wd-lesson">
                            ...
                            <ul className="wd-content">
                                ...
                                <li className="wd-content-item">Formatting content with Lists and
                                    Tables
                                </li>
                            </ul>
                        </li>
